...
## [CLARIFY] Nothing interrupts a paragraph, fences included

A fence opener inside a paragraph run is paragraph content, not a `CodeBlock`; no diagnostic is emitted.
