...
4. [Block Segments](004-block-segments.md) — Paragraph, Section, Meta, CodeBlock, MathBlock, QuoteBlock, List, ListItem, TaskItem, Table, ImageBlock, PageBreaker, FileRef, FileRefGroup, NamedBlock, RefDefinition, SpoilerBlock, CommentBlock
5. [Inline Segments](005-inline-segments.md) — Text, Emphasis, Strong, Highlight, Spoiler, CodeInline, LineBreak, Link, ImageInline, Mark, MathInline, Variable, QuoteInline
